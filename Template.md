...
1. "Quel est le nom de la marque et son objectif en une phrase ?" — Texte libre. Exemple : "ZenExpress — livraison rapide de colis en 2 heures a Dakar."
...
Carte 1 — "Melangeur Diagnostique" : 3 cartes superposees qui cyclent verticalement avec la logique array.unshift(array.pop()) toutes les 3 secondes avec une transition rebond
elastique (cubic-bezier(0.34, 1.56, 0.64, 1)). Labels derives du premier argument de l'utilisateur (generer 3 sous-labels).
